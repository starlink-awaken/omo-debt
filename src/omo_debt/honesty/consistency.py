...
def calculate_consistency(
    ...
    consistency_score = round(
        0.50 * dev_score + 0.25 * time_score + 0.25 * cross_score,
        2
    )
    ...
    return ConsistencyResult(
        ...
        cross_project_diff=_calculate_cross_project_diff(self_rating, similar_project_scores) if similar_project_scores else 0.0,
    )
