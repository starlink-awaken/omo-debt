...
omo-debt is the eCOS v6 technical debt scoring CLI. See [`../README.md`](../README.md) for a quick overview and [`../CAPABILITY-MAP.md`](../CAPABILITY-MAP.md) for capabilities.
