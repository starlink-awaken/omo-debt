...
from omo_debt.honesty.completeness import calculate_completeness, CompletenessResult
from omo_debt.honesty.consistency import calculate_consistency, detect_outlier, ConsistencyResult
