...
If you discover a security vulnerability in omo-debt, please report it responsibly:
...
- Debt scoring reads source code; do not execute untrusted code paths.
- Keep scoring configuration under version control.
